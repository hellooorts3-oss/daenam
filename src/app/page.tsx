  ...
  const coreValues = [
    {
      href: "/about",
      icon: "/아이콘4.png",
      title: "2014년부터 검증된 시공력",
      desc: "2014년 현수에너지로 시작해 누적 설치용량 80MW를 달성했습니다.\n영업·설계·시공·유지보수 전 과정을 자체 인력으로 책임집니다.",
    ...
    },
    {
      ...
      icon: "/아이콘6.png",
      title: "전담 유지보수팀 O&M",
      desc: "전담 유지보수팀이 가동·모니터링을 책임집니다.\n고장 감지 즉시 현장에 대응하여 20년 발전 수명 동안 발전 손실을 최소화합니다.",
    ...
    <div className="flex flex-col bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col gap-6 text-left">
              <div className="animate-rise self-start inline-flex items-center gap-2 px-3 py-1 bg-toss-blue/25 backdrop-blur text-blue-100 ring-1 ring-blue-300/40 rounded-full text-[14px] font-semibold" style={{ animationDelay: "0.1s" }}>
                ...
                2014년부터 쌓아온 태양광 발전 전문성
              </div>

              <h1 className="animate-rise text-[34px] md:text-5xl lg:text-[46px] font-bold text-white leading-[1.25] tracking-tight whitespace-pre-line break-keep drop-shadow-sm" style={{ animationDelay: "0.22s" }}>
                태양광으로 만드는 내일,{"\n"}
                <span className="text-white">대남에너지</span>
              </h1>

              <p className="animate-rise text-lg md:text-[18px] text-white/85 leading-relaxed max-w-2xl break-keep" style={{ animationDelay: "0.34s" }}>
                2014년 설립 이후 누적 설치용량 80MW를 달성한{" "}
                <br className="md:hidden" />
                종합 에너지 솔루션 기업.
                <br />
                RPS 발전사업부터 자가소비, 지붕임대사업까지{" "}
                <br className="md:hidden" />
                안정적인 수익과 RE100 달성을
                <br />
                함께 만들어갑니다.
        ...
        <div className="container-inner">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-10">
            <div className="relative flex flex-col items-center text-center gap-2 reveal-up" data-reveal>
              ...
              <div className="text-[14px] md:text-[15px] text-grey-700 font-medium">태양광 사업 운영</div>
            </div>
          ...
          <div className="flex items-center bg-white">
            <div className="w-full px-6 sm:px-10 lg:pl-16 xl:pl-24 lg:pr-[max(1.5rem,calc((100vw_-_1400px)/2_+_1.5rem))] py-16 lg:py-28">
              <div className="max-w-xl flex flex-col gap-6" data-reveal>
                ...
                <p className="text-[#75787b] leading-relaxed text-base md:text-lg break-keep">
                  대남에너지는{" "}
                  <br className="md:hidden" />
                  RPS 발전사업, 자가소비, 지붕임대사업
                  <br />
      ...
      <section className="py-24 text-white overflow-hidden relative bg-toss-blue bg-[url('/images/cta-field.png')] bg-cover bg-center bg-fixed">
        ...
        <div className="container-inner relative z-10 text-center max-w-3xl mx-auto flex flex-col gap-6 items-center" data-reveal>
          ...
          <p className="text-white/85 text-base md:text-lg leading-relaxed max-w-xl break-keep">
            대남에너지는 과장 없이 가장 보수적이고{" "}
            <br className="md:hidden" />
            객관적인 데이터로
            <br />
            사업타당성을 분석하여{" "}
